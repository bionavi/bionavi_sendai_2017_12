To setup the environment with required packages, grab a copy of anaconda from https://conda.io/miniconda.html and install it, in case not having it installed on your machine.
After installation, activate root environment:
...
>conda install -c conda-forge -c ioam  seaborn geopandas holoviews geoviews
